      ...
      if(items.user) {
        ...
        if(rankPos != 0 && headerName){
          ...
          if(document.querySelector('.panel-leader-board__item-block svg')){
            document.querySelectorAll('.panel-leader-board__item-block')[rankPos - 19].querySelector('svg').replaceWith(flag);
          }
          ...
          if(document.querySelector('.panel-leader-board__item-name')){
            document.querySelectorAll('.panel-leader-board__item-name')[rankPos - 19].innerHTML = headerName.innerHTML;
          }
          ...
          if(document.querySelector('.panel-leader-board__item-avatar')){
            document.querySelectorAll('.panel-leader-board__item-avatar')[rankPos - 19].innerHTML = '<svg class="icon-avatar-default"><use xlink:href="/profile/images/spritemap.svg#icon-avatar-default"></use></svg>';
          }
        }
